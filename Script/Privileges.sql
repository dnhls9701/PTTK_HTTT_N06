...
AS
SELECT KH. *
FROM KHACHHANG KH JOIN TAIKHOAN TK ON KH.MAKHACHHANG = TK.TENTAIKHOAN
WHERE TK.TENTAIKHOAN = CURRENT_USER --CURRETUSER LÀ TÀI KHOẢN ĐANG ĐĂNG NHẬP 
GO
...
AS
SELECT BPDH. *
FROM BOPHANDIEUHANH BPDH JOIN TAIKHOAN TK ON BPDH.MADIEUHANH = TK.TENTAIKHOAN
WHERE TK.TENTAIKHOAN = CURRENT_USER --CURRETUSER LÀ TÀI KHOẢN ĐANG ĐĂNG NHẬP 
GO
-- Gán quyền truy cập đến thông tin cá nhân
...
AS
SELECT NV. *
FROM NHANVIEN NV JOIN TAIKHOAN TK ON NV.MANHANVIEN = TK.TENTAIKHOAN AND NV.VITRI = 1
...
AS
SELECT NV. *
FROM NHANVIEN NV JOIN TAIKHOAN TK ON NV.MANHANVIEN = TK.TENTAIKHOAN AND NV.VITRI = 3
WHERE TK.TENTAIKHOAN= CURRENT_USER 
-- Gán quyền truy cập đến thông tin cá nhân
GO
...
AS
SELECT NV. *
FROM NHANVIEN NV JOIN TAIKHOAN TK ON NV.MANHANVIEN = TK.TENTAIKHOAN AND NV.VITRI = 0
WHERE TK.TENTAIKHOAN= CURRENT_USER 
-- Gán quyền truy cập đến thông tin cá nhân
GO
...
AS
SELECT NV. *
FROM NHANVIEN NV JOIN TAIKHOAN TK ON NV.MANHANVIEN = TK.TENTAIKHOAN AND NV.VITRI = 2
WHERE TK.TENTAIKHOAN= CURRENT_USER 
-- Gán quyền truy cập đến thông tin cá nhân
GO
